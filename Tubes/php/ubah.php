    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="card-panel">
                ...
                <button type="submit" name="ubah" class="waves-effect waves-light red darken-3 btn small">Ubah Data</button>
                <a href="admin.php" class="waves-effect waves-light blue btn small">Kembali</a>
            </div>
        </form>
    </div>
</body>
